                    ...
                    \item \textbf{Pergunta 15) (1 ponto)} Calcule a velocidade do Sol ao redor do centro de massa devido à presença de Júpiter.
                        \red{\begin{itemize}
                            \item Inicialmente, precisamos encontrar a distância de cada componente ao centro de massa, o que pode ser feito usando a relação das massas e a distância entre as componentes:
                                ...
                                \end{equation*}
                            \item Se aproximarmos a órbita para um círculo, temos o seguinte:
                                \begin{equation*} \begin{gathered}
                                    v_S=\sqrt{\frac{G(m_S+m_J)}{r_S}}=\sqrt{\frac{G(m_S+m_J) \left(1+\frac{m_S}{m_J}\right)}{r_{J-S}}} \\
                                    v_S=\sqrt{\frac{6,69 \cdot 10^{-11}(2 \cdot 10^{30}+2 \cdot 10^{27}) \left(1+\frac{2 \cdot 10^{30}}{2 \cdot 10^{27}}\right)}{7,8 \cdot 10^{11}}} \approx 12 \, \frac{m}{s}
                                \end{gathered} \end{equation*}
                        \end{itemize}}
                        \begin{itemize}
