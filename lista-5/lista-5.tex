...
\begin{document}
	...
	\begin{itemize}
		...
		\item \textbf{Questão 5) (1 ponto)} Por muitos anos, houve o debate entre qual modelo seria o mais adequado para descrever o nosso sistema solar: modelo geocêntrico ou heliocêntrico. Para responder as perguntas desta questão, considere os esquemas seguintes, os quais mostram o funcionamento básico de cada modelo:
